...
<?php
    ...
    if (isset($_POST['taskTitleAdd']) && isset($_POST['taskDetailAdd']) && isset($_POST['deadlineAdd']) && isset($_POST['taskEmployeeAdd']))
    {
        ...
        if (empty($taskTitleAdd)) {
            ...
            //     $dest = $_SERVER['DOCUMENT_ROOT'] . '/Lab08/source%20code/images/' .$name;
            //     print_r($dest);
            //     $status = move_uploaded_file($tmp,$dest);
            //     var_dump($status);
